...
__all__ = ['DEFAULT_COLORS', 'plot_2d_fit', 'plot_chirpam_fit', 'plot_chirp_freq_epoch_fit', 'plot_transient_fit',
           'plot_nonlinearity_fit', 'plot_ds_wheel', 'plot_fl_bars', 'plot_t_sta', 'plot_chirp', 'plot_spike_template',
           'plot_spike_template_MEA', 'plot_autocorrelogram', 'plot_spike_amplitudes', 'plot_calcium_trace',
