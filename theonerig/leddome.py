...
__all__ = ['generate_positions', 'as_cartesian', 'as_spherical']
...
def generate_positions(mode="cartesian"):
    ...
    if mode=="spherical":
        res = np.apply_along_axis(as_spherical, axis=-1, arr=generate_positions())
    return res
